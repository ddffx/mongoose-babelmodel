  ...
  _createClass(Model, [{
    ...
    value: function extend(extension) {
      ...
      extendedPaths.forEach(function (extendedPath) {
        ...
        _this[extendedPath] = extension[extendedPath];
      });
      ...
      try {
        for (var _iterator = prototypeKeys[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
      ...
      try {
        for (var _iterator2 = staticKeys[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
        ...
        if (!this.constructor.hasOwnProperty('plugins')) {
          ...
          try {
            var _loop = function () {
              ...
              // noinspection Eslint
              if (_this.constructor.plugins.find(function (element) {
                return element.fn.name === plugin.fn.name;
              }) === undefined) {
                _this.constructor.plugins.push(plugin);
              }
            };

            for (var _iterator3 = extension.constructor.plugins[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
              _loop();
            }
          } catch (err) {
    ...
    value: function buildSchemaObject() {
      ...
      paths.forEach(function (path) {
        _this2._schema[path] = _this2[path];
      });
      (0, _helpers.fixObjectIds)(this._schema);
    }
    ...
    value: function generateSchema() {
      ...
      var staticProps = (0, _helpers.getFunctionNamesOrdered)(self);
      var prototypeProps = (0, _helpers.getFunctionNamesOrdered)(proto);
      ...
      try {
        for (var _iterator4 = staticProps[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
      ...
      try {
        for (var _iterator5 = instanceProps[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
      ...
      if (this.constructor.hasOwnProperty('plugins')) {
        ...
        try {
          for (var _iterator6 = this.constructor.plugins[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
    ...
    get: function get() {
      ...
      return {
        ...
        add: function add() {
          ...
          try {
            for (var _iterator7 = Object.keys(schema)[Symbol.iterator](), _step7; !(_iteratorNormalCompletion7 = (_step7 = _iterator7.next()).done); _iteratorNormalCompletion7 = true) {
              ...
              if (!_this3._schema[key] || overwrite) {
                _this3._schema[key] = schema[key];
              }
            }
          } catch (err) {
          ...
          return Object.keys(_this3._schema);
        },
        remove: function remove() {
          ...
          try {
            for (var _iterator8 = schema[Symbol.iterator](), _step8; !(_iteratorNormalCompletion8 = (_step8 = _iterator8.next()).done); _iteratorNormalCompletion8 = true) {
              var key = _step8.value;

              if (_this3._schema[key]) {
                delete _this3._schema[key];
              }
            }
          } catch (err) {
